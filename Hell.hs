...
dispatch :: Command -> IO ()
dispatch Version = putStrLn "2024-02-20"
...
-- whitespace.
lexer :: ByteString -> FP.Result LexError (Vector (Located Loc Token))
lexer s = do
 ...
 where
   ...
   -- TODO: Proper string lexer. Doesn't handle backslash. read is partial.
